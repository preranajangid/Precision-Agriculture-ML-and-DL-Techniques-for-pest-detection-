...
path1 = 'D:/Code/Agri pest/archive/pest/test/stem_borer'    #path of folder of images    
path2 = 'D:/Code/Agri pest/100% code Medical herb/dataset/testing/9'  #path of folder to save images    
